...
def load_data_staging(df, table_name: str, conn_url: str):
    """
...
load_data_staging(df, 'staging_retail_sales', 'postgresql+psycopg2://parcial3_user:UnaClav3@localhost:5432/parcial3_bodegas')